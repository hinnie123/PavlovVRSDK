...
struct FBodyInstance
{
	...
	float                                              PhysicsBlendWeight;                                       // 0x00E0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PositionSolverIterationCount;                             // 0x00E4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x28];                                      // 0x00E8(0x0028) MISSED OFFSET
	...
	unsigned char                                      UnknownData09[0xF8];                                      // 0x0124(0x00F8) MISSED OFFSET
	ESleepFamily                                       SleepFamily;                                              // 0x021C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EDOFMode>                              DOFMode;                                                  // 0x021D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECollisionEnabled>                     CollisionEnabled;                                         // 0x021E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     ObjectType;                                               // 0x021F(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
};
...
{
	unsigned char                                      UnknownData00[0x3C0];                                     // 0x0000(0x03C0) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x180];                                     // 0x03C0(0x0180) MISSED OFFSET
};
