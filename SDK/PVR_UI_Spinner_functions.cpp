...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function UI_Spinner.UI_Spinner_C.Tick"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function UI_Spinner.UI_Spinner_C.ExecuteUbergraph_UI_Spinner"));
